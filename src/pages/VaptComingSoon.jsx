    ...
    <>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn delay={0}>
            <span className="inline-block rounded-full bg-[#0A2540]/5 text-[#0A2540] text-[12px] font-semibold uppercase px-4 py-2" style={{ letterSpacing: '2px' }}>
          ...
          <FadeIn delay={0.3}>
            <a
              href="#early-access"
              className="inline-block mt-8 bg-[#0A2540] text-white text-sm font-semibold rounded-lg transition-colors duration-200 hover:bg-[#0D3560]"
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {features.map((feature, i) => (
            <FadeIn key={feature.title} delay={i * 0.1}>
              <div className="h-full border border-[#E5E5E5] rounded-xl p-6 transition-colors duration-200 hover:border-[#0A2540]">
      ...
      {/* ── SECTION 3: PRICING ── */}
      <section className="bg-[#F5F5F5] py-[70px] md:py-[100px] px-6">
        <div className="max-w-2xl mx-auto text-center">
          <FadeIn>
            <h2 className="font-bold text-[#1A1A1A] text-[26px] md:text-[36px]">
              Pricing
            </h2>
            <div className="flex justify-center">
          ...
          <FadeIn delay={0.1}>
            <div className="bg-white border border-[#E5E5E5] rounded-2xl p-8 md:p-10 text-left">
              <p className="text-[#6B7280] text-[15px] md:text-[16px]">
                Complete VAPT Audit
              </p>
              <p className="font-bold text-[#1A1A1A] text-[40px] md:text-[48px] mt-1">
                $4,500
              </p>
              <ul className="flex flex-col gap-4 mt-6">
                {pricingIncludes.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    <span className="text-[#0A2540] font-bold text-[16px] mt-0.5 flex-shrink-0">
                      ✓
                    </span>
                    <span className="text-[15px] md:text-[16px] text-[#6B7280]">
                      {item}
                    </span>
                  </li>
                ))}
      ...
      <section id="early-access" className="bg-white py-[70px] md:py-[100px] px-6 scroll-mt-20">
        <div className="max-w-xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-[#6B7280] leading-relaxed text-[16px] md:text-[18px]">
          ...
          <FadeIn delay={0.1}>
            {submitted ? (
              <p className="mt-8 text-[#0A2540] font-medium text-[16px]">
              ...
              >
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3 rounded-lg bg-white border border-[#E5E5E5] text-[#1A1A1A] placeholder-[#9CA3AF] transition-colors duration-200 focus:outline-none focus:border-[#0A2540]"
                />
                <button
                  type="submit"
                  className="bg-[#0A2540] text-white text-sm font-semibold rounded-lg transition-colors duration-200 hover:bg-[#0D3560] whitespace-nowrap"
                  style={{ padding: '12px 24px' }}
                >
                  Notify Me
                </button>
      ...
      <section className="bg-[#F5F5F5] py-[70px] md:py-[100px] px-6">
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            <h2 className="font-bold text-[#1A1A1A] text-center text-[26px] md:text-[36px]">
              FAQ
            </h2>
            <div className="flex justify-center">
              <GradientLine className="mt-5 mb-10" />
            ...
            {faqs.map((faq, i) => (
              <FadeIn key={faq.q} delay={i * 0.05}>
                <div className="bg-white border border-[#E5E5E5] rounded-xl p-6">
                  <h3 className="font-bold text-[#1A1A1A] text-[16px] md:text-[18px]">
                    {faq.q}
                  </h3>
      ...
      <section className="bg-white py-[70px] md:py-[100px] px-6">
        <div className="max-w-2xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-[#6B7280] mt-5 leading-relaxed text-[16px] md:text-[18px]">
